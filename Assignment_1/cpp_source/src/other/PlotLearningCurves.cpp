	...
	bool writeToCSV)
{
	...
	//string plotFileName = "output/" + (string)title + ".bmp";
	string plotFileName = "/Users/ankitamehta/Desktop/masters/RL_687/Assignment_1/cpp_source/" + (string)title + ".bmp";
	p.save(plotFileName);
	...
	{
		// Write to file
		//string fileName = "output/" + (string)title + ".csv";
		string fileName = "/Users/ankitamehta/Desktop/masters/RL_687/Assignment_1/cpp_source/" + (string)title + ".csv";
